...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?= site_url();?>">APOTEK YOLO</a>
    </div>
    <div class="collapse navbar-collapse" id="navigasi">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="<?= site_url('home/review');?>">REVIEW</a></li>
        ...
        <li><a href="<?= site_url('admin');?>">LOGIN <span class="glyphicon glyphicon-user"></a></li>
        <li></li>
      </ul>
    </div>
  </div>
