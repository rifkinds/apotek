...
<div class="container" style="margin-bottom: 50px">
  <div class="col-md-offset-3 col-md-6">
    <form action="<?= site_url('admin/editReview/'.$review->id_review);?>" method="post">
      <?= $message; ?>
      <div class="row">
            <div class="col-md-6">
      ...
      <div class="row">
        <div class="form-group">
          ...
          <input type="button" class="btn btn-success" name="back" value="BACK" onclick="window.location.href='http://localhost/apotek/index.php/admin/lihat_review'">
      </div>
    </form>
  </div>
</div>