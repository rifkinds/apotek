...
class Admin_model extends CI_Model {
  ...
  public function insertObat(){
    ...
    $q = "INSERT INTO obat VALUES
          ('$kode', '$nama', '$bentuk', '$konsum', '$manfaat', '$harga','$gambar')";
  ...
  public function insertAkun(){
    ...
    $q = "INSERT INTO admin VALUES('$id_admin', '$username','$password', '$nama')";
  ...
  public function deleteAkun($id_admin){
    $q = "DELETE FROM admin WHERE id_admin = '$id_admin'";
    if($this->db->query($q))
      return true;
    else
      return false;
  ...
  public function updateAkun($id_admin){
    ...
    $q ="UPDATE admin SET id_admin = $id_admin, username = '$username', password = '$password', nama = '$nama'
