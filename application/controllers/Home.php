...
class Home extends CI_Controller {
  ...
  public function review(){
    ...
    if($this->input->post('insertReview')){
      if($this->home_model->insertReview())
        $this->session->set_flashdata('msg', '<div class="alert alert-success">Review '. $this->input->post('nama') .' berhasil dimasukkan kedalam database</div>');
      else
        $this->session->set_flashdata('msg', '<div class="alert alert-danger"><b>Terjadi kesalahan</b>, review gagal dimasukkan kedalam database</div>');
  ...
  public function editReview($id_review){
    ...
    if($this->input->post('editReview')){
      ...
      redirect(site_url('home/editReview/'.$id_review));
    }
    else {
  ...
  public function hapusReview($id_review){
    ...
    if($this->home_model->deleteReview($id_review)){
      ...
      redirect(site_url('home/lihat_review/'.$id_review));
    }
    else{
